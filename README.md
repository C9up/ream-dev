...
| `@c9up/vellum` | PDF — render pages to images, read text and metadata, merge/split/rotate, stamp, fill and flatten forms, sign |
...
blackhole, chronos, eon, helix, inker, ream-mcp, rover, rune, sigil, vellum,
warden.
